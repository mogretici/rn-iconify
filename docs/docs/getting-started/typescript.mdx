...
title: TypeScript
sidebar_position: 3
description: Full TypeScript support with autocomplete for all 268,000+ icons
keywords: [typescript, autocomplete, types, intellisense]
---
...
## Tree-Shaking with Deep Imports
...
For the best type safety, use the [Icon Aliases](/docs/features/icon-aliases) feature:
...
- [Icon Aliases](/docs/features/icon-aliases) - Type-safe custom icon names
- [Theme Provider](/docs/features/theme-provider) - Global styling
- [API Reference](/docs/api-reference/types) - All type exports
